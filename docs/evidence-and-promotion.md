...
1. The `Evaluator` library retains declarative-candidate observations, but G0 rejects every external provider launch before invocation and records `SANDBOX_UNAVAILABLE` until a concrete checked-in supervisor and authority exist.
